...
public class CompromissoListFilter {

	private java.util.List<String> titulo;
	
	// Map field for developer customizing parameters.
	private Map<Object, Object> customParams = new HashMap<>();
	
	public java.util.List<String> getTitulo() {
		return titulo;
	}
	
	public void setTitulo(java.util.List<String> titulo) {
		this.titulo = titulo;
	}
